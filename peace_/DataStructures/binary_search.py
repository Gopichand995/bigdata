...
if __name__ == "__main__":
    ...
    index1 = linear_search(numbers_list, number_to_find)
    print(f"Number found at index {index1} using linear search")
    ...
    print(f"Number found at index {index3} using binary search recursive")
