...
names = spark.read.schema(schema).option("sep", " ").csv(
    "file:///C:/Users/04647U744/Documents/Github/pyspark/Marvel+Names.txt")

lines = spark.read.text("file:///C:/Users/04647U744/Documents/Github/pyspark/Marvel+Graph.txt")
...
# print(minConnectionsWithNames.show())
print("@@@@@@@@@@@##################*****************")
