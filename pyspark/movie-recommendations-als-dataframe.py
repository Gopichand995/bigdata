...
def loadMovieNames():
    ...
    # with codecs.open("file:///C:/Users/04647U744/Gopichand/pyspark/ml-100k/u.item", "r", encoding='ISO-8859-1',
    #                  errors='ignore') as f:
    with open("C:/Users/04647U744/Documents/Github/pyspark/ml-100k/u.ITEM", "r") as f:
        for line in f:
            fields = line.split('|')
...
ratings = spark.read.option("sep", ",").schema(moviesSchema).csv("file:///C:/Users/04647U744/Desktop/u1.csv")
